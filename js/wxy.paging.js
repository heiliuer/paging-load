...
(function (factory) {
    ...
    ptype.init = function () {
        ...
        if (options.handler.triggerByScroll) {
            ...
            self.debuglog("scroller:", self._$scroller);
            self.debuglog("scrollHolder:", this._$scrollHolder);
            // .off(evScroll)
            self._$scroller.on(evScroll, function (event, force) {
                self.debuglog("scroll.paging");
    ...
    ptype.enableScroll = function () {
        this.debuglog("enableScroll:_$scroller", this._$scroller);
